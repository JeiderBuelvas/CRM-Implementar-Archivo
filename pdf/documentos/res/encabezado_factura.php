    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #34495e;font-size:12px;text-align:center">
                <span style="color: #34495e;font-size:20px;font-weight:bold"><?php echo get_row('perfil','nombre_empresa', 'id_perfil', 1);?></span>
                <br>NIT: <?php echo get_row('perfil','nit_empresa', 'id_perfil', 1);?>
