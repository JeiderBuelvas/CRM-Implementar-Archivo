<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO clientes (cedula, nombre_cliente, contacto, cargo, ciudad, telefono_cliente, email_cliente, direccion_cliente, status_cliente, date_added) VALUES ('$cedula','$nombre','$contacto','$cargo','$ciudad','$telefono','$email','$direccion','$estado','$date_added')";
