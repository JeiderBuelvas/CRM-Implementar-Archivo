			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="warning">
					<th>Código</th>
					<th>Servicios</th>
					<th><span class="pull-right">Kg / Und.</span></th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<input type="text" readonly onmousedown="return false;" class="form-control" style="text-align:right" id="kilogramos<?php echo $id_producto; ?>"  value="<?php echo $kilogramos;?>" >
						</div></td>
						<td class='col-xs-1'>
