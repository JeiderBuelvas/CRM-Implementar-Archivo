<?php
	...
	if (empty($_POST['nombre_empresa'])) {
		...
		$nit_empresa=mysqli_real_escape_string($con,(strip_tags($_POST["nit_empresa"],ENT_QUOTES)));
		...
		$sql="UPDATE perfil SET  nombre_empresa='".$nombre_empresa."', nit_empresa='".$nit_empresa."', telefono='".$telefono."', email='".$email."', impuesto='".$impuesto."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal' WHERE id_perfil='1'";
