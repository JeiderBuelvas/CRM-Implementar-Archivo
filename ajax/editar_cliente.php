<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET cedula='".$cedula."', nombre_cliente='".$nombre."', contacto='".$contacto."', cargo='".$cargo."', ciudad='".$ciudad."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."', id_moneda='".$id_moneda."' WHERE id_cliente='".$id_cliente."'";
