...
<body>
 <div class="container">
    ...
    .foto-login img {
        ...
        max-height: 100%; /* La imagen no será más grande que el contenedor */
    }
</style>

            <center><img id="profile-img" class="foto-login" src="img/logo.png" /></center>
			...
			<?php
                ...
                <button type="submit" class="btn btn-lg btn-success btn-block btn-signin" name="login" id="submit" style="background-color: #1f3d8f;">Iniciar Sesión</button>
