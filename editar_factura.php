...
<html lang="en">
  ...
  <body>
    ...
    <h4>
        ...
        Modificar Orden (O.P) = <?php echo $numero_factura; ?>
    </h4>
    </div>
			...
			<form class="form-horizontal" role="form" id="datos_factura">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
                            ...
                            <option value="1" <?php if ($estado_factura == 1) { echo "selected"; } ?>>ALTO</option>
                            <option value="2" <?php if ($estado_factura == 2) { echo "selected"; } ?>>MEDIO</option>
                            <option value="3" <?php if ($estado_factura == 3) { echo "selected"; } ?>>BAJO</option>
                            </select>
                           </div>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="" onclick="imprimir_factura('<?php echo $id_factura;?>')">
