		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				<label for="mod_kilogramos" class="col-sm-3 control-label">Kg / Unt.</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_kilogramos" name="mod_kilogramos" placeholder="Kilogramos" required>
				</div>
			  </div>
