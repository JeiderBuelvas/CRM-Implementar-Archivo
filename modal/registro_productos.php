		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				<label for="kilogramos" class="col-sm-3 control-label">Kg / Unt.</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="kilogramos" name="kilogramos" placeholder="Kilogramos" required>
				</div>
			  </div>
